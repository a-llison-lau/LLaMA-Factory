#!/bin/bash
#SBATCH --job-name=ppt_sysprompt_sweep
#SBATCH --nodes=1
#SBATCH --mem=48G
#SBATCH --ntasks-per-node=1
#SBATCH --cpus-per-task=6
#SBATCH --gres=gpu:4
#SBATCH --output=ppt_sysprompt_sweep.%j.out
#SBATCH --error=ppt_sysprompt_sweep.%j.err
...
wandb agent allison-lau-university-of-toronto/LLaMA-Factory/ar06zm59